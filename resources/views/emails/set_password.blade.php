...
<body>
    ...
    <p>Silahkan ikuti langkah-langkah berikut untuk melanjutkan proses pemesanan kos:</p>
    <ol style="margin-left: 20px;">
        <li>Buatlah kata sandi baru untuk dapat masuk ke akun Anda <a href="{{ $url_setpassword }}">disini</a>.</li>
        <li>Login menggunakan alamat email yang Anda daftarkan beserta kata sandi baru.</li>
